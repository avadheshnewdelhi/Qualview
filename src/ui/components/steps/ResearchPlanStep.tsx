                ...
                >
                    <div className="text-center space-y-4">
                        ...
                        <Button
                            ...
                            className="w-full"
                            disabled={!isSignedIn || !isOnline || !framing}
                        >
                ...
                editPanel={
                    <EditPanel
                        ...
                        onUpdated={(newContent, newConf, newSuggestions) => {
                            ...
                            addResearchObject('plan', newContent, newConf as ConfidenceLevel, newSuggestions);
                        }}
                        placeholder='e.g., "Add a contingency plan for low recruitment" or "Focus more on mobile"'
                        contextPlaceholder='e.g., "We only have 2 weeks for recruitment" or "Budget is limited to $5k"'
                    />
                }
            >
                {/* Goal */}
